...
public class AudioService
{
    ...
    private void ApplyMusicVolume(float value) => m_audioMixer.SetFloat("MusicVolume", Mathf.Log10(Mathf.Max(value, 0.0001f)) * 20f);

    private void ApplySoundsVolume(float value) => m_audioMixer.SetFloat("SoundsVolume", Mathf.Log10(Mathf.Max(value, 0.0001f)) * 20f);
}
